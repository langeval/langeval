...
> [!TIP]
> **🚀 Live Demo**: Trải nghiệm nền tảng trực tuyến tại [langeval.space](https://langeval.space)
...
*   **Tổng quan**: [Master Plan](langeval-ui/docs/00-Master-Plan.md), [Business Requirements](langeval-ui/docs/00-Business-Requirements.md)
*   **Kỹ thuật**: [System Architecture](langeval-ui/docs/01-System-Architecture.md), [Database Design](langeval-ui/docs/03-Database-Design.md), [API Spec](langeval-ui/docs/04-API-Microservices-Spec.md)
*   **Vận hành**: [Deployment & DevOps](langeval-ui/docs/06-Deployment-DevOps.md), [Security](langeval-ui/docs/07-Security-Compliance.md)
