...
[![Documentation](https://img.shields.io/badge/docs-read%20now-F9A825?logo=bookstack)](langeval-ui/docs)
...
> [!TIP]
> **🚀 Live Demo**: Explore the platform in action at [langeval.space](https://langeval.space)
...
*   **Overview**: [Master Plan](langeval-ui/docs/00-Master-Plan.md), [Business Requirements](langeval-ui/docs/00-Business-Requirements.md)
*   **Technical**: [System Architecture](langeval-ui/docs/01-System-Architecture.md), [Database Design](langeval-ui/docs/03-Database-Design.md), [API Spec](langeval-ui/docs/04-API-Microservices-Spec.md)
*   **Authentication**: [Google OAuth Setup Guide](langeval-core/identity-service/GOOGLE_SETUP.md)

*   **Operations**: [Deployment & DevOps](langeval-ui/docs/06-Deployment-DevOps.md), [Security](langeval-ui/docs/07-Security-Compliance.md)
