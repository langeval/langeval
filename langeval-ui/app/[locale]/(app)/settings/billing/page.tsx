...
export default function BillingPage() {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto space-y-8">
            ...
            <div className="mt-16 bg-slate-900/90 rounded-3xl p-8 border border-white/5 relative overflow-hidden">
            ...
            <div className="mt-16 bg-slate-900/90 rounded-3xl p-8 border border-white/5 relative z-10">
