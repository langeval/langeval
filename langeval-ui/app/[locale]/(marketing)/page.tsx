            ...
            <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0B0F19]/80 backdrop-blur-md supports-[backdrop-filter]:bg-[#0B0F19]/60">
                <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
                        ...
                        <a href="/docs/00-Business-Requirements" className="hover:text-white transition-colors">{t('Navbar.docs')}</a>
                    </div>
                            ...
                            <SheetContent side="right" className="bg-[#0B0F19] border-white/10 text-slate-300">
                                <div className="flex flex-col gap-6 mt-8">
                                    <div className="flex flex-col gap-4 text-lg font-medium">
                                        ...
                                        <a href="#pricing" className="hover:text-white transition-colors py-2 border-b border-white/5">{t('Navbar.pricing')}</a>
                                        <a href="#testimonials" className="hover:text-white transition-colors py-2 border-b border-white/5">{t('Navbar.customers')}</a>
                                        <a href="/docs/00-Business-Requirements" className="hover:text-white transition-colors py-2 border-b border-white/5">{t('Navbar.docs')}</a>
                                    </div>
