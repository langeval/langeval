    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                ...
                "description": "A RAG-based bot for handling banking inquiries.",
                "endpoint_url": "https://api.example.com/chat",
                "type": "RAG Chatbot",
                "version": "v1.1.0",
                "api_key": "sk-your-secret-key",
                "meta_data": {"provider": "OpenAI", "model": "gpt-4o"}
            }
        }
    }
...
class KnowledgeBaseRef(SQLModel, table=True):
    ...
    """
    __tablename__ = "knowledge_base_ref"
...
class KnowledgeBaseCreate(SQLModel):
    ...
    chunking_strategy: Optional[str] = "fixed-size"
    vector_db_type: Optional[str] = "chroma"
    vector_db_config: Optional[Dict] = {}
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                ...
                "source_path": "s3://vf-docs/manual.pdf",
                "description": "Official owner manual",
                "type": "document"
            }
        }
    }
...
class KnowledgeBaseUpdate(SQLModel):
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                "description": "Updated documentation for Q3.",
                "status": "ready",
...
class ScenarioCreate(SQLModel):
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                "name": "Refund Flow Scenario",
                "description": "Tests the agent's ability to process refunds.",
                "workspace_id": "660e8400-e29b-41d4-a716-446655441111",
                "nodes": [
                    {"id": "start", "type": "input", "position": {"x": 0, "y": 0}, "data": {"label": "USER START"}},
                    {"id": "node-1", "type": "custom", "position": {"x": 200, "y": 0}, "data": {"content": "I want a refund for item #123"}}
                ],
                "edges": [
...
class ScenarioUpdate(SQLModel):
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                "name": "Refund Flow - Version 2",
                "description": "Updated flow with edge case handling"
            }
        }
    }
...
class MetricConfigRef(SQLModel, table=True):
    ...
    """
    __tablename__ = "metric_config_ref"
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                ...
                "type": "API",
                "api_key": "sk-proj-...",
                "meta_data": {"context_window": 128000}
            }
        }
    }
...
class RedTeamingCampaign(SQLModel, table=True):
    ...
    """
    __tablename__ = "red_teaming_campaign"
...
class RedTeamingCampaignCreate(SQLModel):
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                "name": "Red Teaming - Jailbreak Test",
                "agent_id": "agent-123",
                "strategy": "jailbreak",
                "intensity": 80
            }
